      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
              <div class="card-icon">
                <a href="{{route('createNotices')}}" style="text-decoration:inherit;color:inherit;">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="card card-stats">
            ...
            <div class="card-footer">
                <h4>Number of Notices</h4>
            </div>
          </div>
        </div>
      </div>
      <div class="row">
       @foreach($noticesArticles as $article)
        <div class="col-md-3">
          <div class="card card-chart">
            ...
            <div class="card-footer">
              <div class="stats">
                <a href="{{$article->pdf_link}}">
                  <i class="fa fa-download" aria-hidden="true"></i>
                </a>
              </div>
              <div class="stats">
                <a href="{{route('deleteNotices',['id' => $article->id])}}">
