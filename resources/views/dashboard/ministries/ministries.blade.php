...
<div class="main-panel">
  ...
  <div class="content">
    <div class="container-fluid">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-info card-header-icon">
              <div class="card-icon">
                <a href="{{route('createMinistries')}}" style="text-decoration:inherit;color:inherit;">
      ...
      <div class="row">
       @foreach($ministriesArticles as $article)
        <div class="col-md-3">
          <div class="card card-chart">
            ...
            <div class="card-footer">
              <div class="stats">
                <a href="{{route('editMinistries',['id' => $article->id])}}">
                  <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                </a>
              </div>
              <div class="stats">
                <a href="{{route('deleteMinistries',['id' => $article->id])}}">
